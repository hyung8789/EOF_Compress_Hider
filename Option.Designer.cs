...
namespace EOF_Compress_Hider
{
    partial class Option
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.innerOption_tableLayoutPanel.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 5F));
            this.innerOption_tableLayoutPanel.Controls.Add(this.password_groupBox, 1, 3);
            this.innerOption_tableLayoutPanel.Controls.Add(this.compressLevel_groupBox, 1, 2);
            this.innerOption_tableLayoutPanel.Controls.Add(this.overwrite_groupBox, 1, 1);
            ...
            this.warning_label.Text = "주의 : 출력 파일을 지정하지 않고 기존 커버 이미지 파일에 덮어쓰지만 \r\n기존 커버 이미지 파일이 손상될 수 있습니다";
            // 
            // overwrite_checkBox
            // 
